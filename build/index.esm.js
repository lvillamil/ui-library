...
import React__default, { Component, createElement, useReducer, useRef, useEffect, isValidElement, cloneElement, Children, useState, useMemo, useCallback } from 'react';
import PropTypes from 'prop-types';
import classNames from 'classnames';
import Button from 'react-bootstrap/Button';
import ReactDOM, { render } from 'react-dom';
import ReactBootstrapBadge from 'react-bootstrap/Badge';
import { format as format$1, isDate, parseISO } from 'date-fns';
import 'react-dates';
...
var Card = function Card(props) {
  ...
  }, title), titleActions && titleActions), /*#__PURE__*/React__default.createElement("div", {
...
var Paginate = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Paginate, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
      ...
      }, /*#__PURE__*/React__default.createElement("div", null, itemsList), /*#__PURE__*/React__default.createElement("div", {
        className: "paginate-section"
      }, /*#__PURE__*/React__default.createElement(Button, {
        className: "btn-primary button prev",
        onClick: this.onClickPrev,
        disabled: currentPage === 1
      }, /*#__PURE__*/React__default.createElement(SvgKeyboardArrowLeft, {
        className: "arrow-icon"
      }), previousLabel), /*#__PURE__*/React__default.createElement("span", {
        className: "static-text"
      }, "Page"), /*#__PURE__*/React__default.createElement("input", {
        type: "number",
        className: "input",
        value: currentPage,
        max: totalPages,
        ...
        className: "static-text"
      }, "of ".concat(totalPages)), /*#__PURE__*/React__default.createElement("span", {
        className: "select-container"
      }, /*#__PURE__*/React__default.createElement("select", {
        value: selectCurrentValue,
        className: "select",
        onChange: this.onChangeSelect
      }, selectOptions)), /*#__PURE__*/React__default.createElement(Button, {
        className: "btn-primary button next",
        onClick: this.onClickNext,
        disabled: currentPage === totalPages
      }, nextLabel, /*#__PURE__*/React__default.createElement(SvgKeyboardArrowRight, {
        className: "arrow-icon"
      }))));
    }
  }]);
...
_defineProperty(Paginate, "propTypes", {
  ...
  items: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.string), PropTypes.arrayOf(PropTypes.node)]).isRequired,
  rowsPerPageDefault: PropTypes.oneOfType([PropTypes.number, PropTypes.string]).isRequired,
...
var SimpleList = function SimpleList(props) {
  ...
  return showPagination ? /*#__PURE__*/React__default.createElement(Paginate, {
    items: items,
    rowsPerPageOptions: [2, 4, 6, 10],
    rowsPerPageDefault: 10
  }) : /*#__PURE__*/React__default.createElement("div", {
    className: classNames('simple-list', className)
  }, items);
};
...
var LoadingOverlay = function LoadingOverlay(_ref) {
  ...
  return loading && /*#__PURE__*/React__default.createElement("div", _extends$6({
    className: classNames('ui-library loading-overlay-container flex-fill', {
      'full-size': fullSize,
      'modal-overlay': isModalOverlay
    }),
    "data-testid": "loading-overlay"
  }, rest), /*#__PURE__*/React__default.createElement(LoadingSpinner, null));
};
...
function cssTransition(_ref) {
  ...
  return function ToastTransition(_ref2) {
    ...
    return createElement(Transition$1, Object.assign({}, props, {
...
var Arrow = function Arrow(_ref) {
  ...
  switch (position) {
    case 'up':
      return /*#__PURE__*/React__default.createElement(SvgKeyboardArrowUp, rest);

    case 'down':
      return /*#__PURE__*/React__default.createElement(SvgKeyboardArrowDown, rest);

    case 'left':
      return /*#__PURE__*/React__default.createElement(SvgKeyboardArrowLeft, rest);

    case 'right':
      return /*#__PURE__*/React__default.createElement(SvgKeyboardArrowRight, rest);
...
var StatusFlag = function StatusFlag(_ref) {
  var status = _ref.status,
      type = _ref.type,
      className = _ref.className;
  return /*#__PURE__*/React__default.createElement(ReactBootstrapBadge, {
...
var format = function format(date, formatToken) {
  return format$1(isDate(date) ? date : parseISO(date), formatToken);
};
...
var LinkedCasesListItem = function LinkedCasesListItem(_ref) {
  ...
  var caseTypeLabel = useMemo(function () {
  ...
  var datePublishedStr = useMemo(function () {
    if (datePublished) {
  ...
  var caseDetailURL = useMemo(function () {
    var redirectTo = '';
  ...
  var linkButton = function linkButton(urlCase) {
    if (isTraceorLeadCase) {
      return !(status === 'Published' || status === 'Updated') ? /*#__PURE__*/React__default.createElement(Button, {
        className: "p-0 link-btn",
        "data-testid": "case-item-link",
        onClick: onUnpublished
      }, /*#__PURE__*/React__default.createElement("span", {
        title: buttonContent
      }, buttonContent)) : /*#__PURE__*/React__default.createElement(Button, {
        className: "p-0 link-btn",
        "data-testid": "case-item-link",
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, !isTraceCase && /*#__PURE__*/React__default.createElement(Arrow, {
  ...
  }, linkButton(caseDetailURL), /*#__PURE__*/React__default.createElement("div", {
    className: "d-block"
  }, /*#__PURE__*/React__default.createElement("span", null, caseTypeLabel), /*#__PURE__*/React__default.createElement("span", {
    className: "gray"
  }, "- ".concat(datePublishedStr)), /*#__PURE__*/React__default.createElement(StatusFlag, {
    status: status,
    className: "status-badge",
    type: "tl-case"
  })), enableDeleteAction && !deletionOnlyOnExpanded && /*#__PURE__*/React__default.createElement("div", {
    className: "iconbox"
  }, /*#__PURE__*/React__default.createElement(Button, {
    "data-testid": "remove-linked-case",
    className: "d-flex align-items-center remove-btn",
    onClick: handleOnRemove
  }, /*#__PURE__*/React__default.createElement(SvgDelete, {
    fill: "#006ba6"
  }))), deletionOnlyOnExpanded && isExpanded && /*#__PURE__*/React__default.createElement("div", {
    className: "iconbox"
  }, /*#__PURE__*/React__default.createElement(Button, {
    "data-testid": "remove-linked-case",
    className: "d-flex align-items-center remove-btn",
    ...
    fill: "#006ba6"
  })))))), isExpanded ? /*#__PURE__*/React__default.createElement("div", {
    ...
    className: "label"
  }, "Merchant ID"), /*#__PURE__*/React__default.createElement("p", {
    className: "description"
  }, addPlaceholder(mid))), /*#__PURE__*/React__default.createElement("div", {
    className: "col-sm-6"
  }, /*#__PURE__*/React__default.createElement("span", {
    className: "label"
  }, "Status"), status === '--' ? /*#__PURE__*/React__default.createElement("p", {
    className: "description"
  }, status) : /*#__PURE__*/React__default.createElement(StatusFlag, {
    status: status,
    type: "tl-case"
  })), /*#__PURE__*/React__default.createElement("div", {
    className: "col-sm-6"
    ...
    className: "label"
  }, "Merchant Name"), /*#__PURE__*/React__default.createElement("p", {
    className: "description"
  }, addPlaceholder(merchantName))), /*#__PURE__*/React__default.createElement("div", {
    className: "col-sm-12"
  }, /*#__PURE__*/React__default.createElement("span", {
    className: "label"
  }, "Merchant URL"), /*#__PURE__*/React__default.createElement("p", {
    className: "description"
  }, addPlaceholder(url))), !viewOnly && /*#__PURE__*/React__default.createElement("div", {
    className: "col-sm-12",
    "data-testid": "client-name"
  }, /*#__PURE__*/React__default.createElement("span", {
    className: "label"
  }, "Client"), /*#__PURE__*/React__default.createElement("p", {
    className: "description"
...
var LinkedCases = function LinkedCases(_ref) {
  ...
  var handleRemoveItem = useCallback( /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              modalHeader = /*#__PURE__*/React__default.createElement("span", {
                className: "modal-title"
              }, "Remove Linked Case");
              prompt = /*#__PURE__*/React__default.createElement("div", null, "Are you sure you want to proceed?");
              _context.next = 4;
  ...
  var renderItem = function renderItem(value, index) {
    return /*#__PURE__*/React__default.createElement(LinkedCasesListItem, {
      key: value.caseId,
      caseTypes: caseTypes,
  ...
  var showNoCasesFoundMessage = useMemo(function () {
  ...
  }, /*#__PURE__*/React__default.createElement(LoadingOverlay, {
    loading: isLoading,
    fullSize: true
  }), /*#__PURE__*/React__default.createElement("div", {
  ...
  }, showNoCasesFoundMessage && /*#__PURE__*/React__default.createElement("p", {
    className: "no-cases-found-message",
    "data-testid": "no-linked-cases-message"
  }, "No Linked Cases"), linkedCases && /*#__PURE__*/React__default.createElement(SimpleList, {
    data: linkedCases,
    renderItem: renderItem,
    showPagination: false
  }), enableLinkCaseAction && !viewOnly && /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Button, {
...
LinkedCases.propTypes = {
  ...
  linkedCases: PropTypes.arrayOf(PropTypes.shape({
    caseId: PropTypes.number,
